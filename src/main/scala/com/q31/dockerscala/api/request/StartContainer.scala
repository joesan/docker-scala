 ...
 */
class StartContainer(id: ContainerId, params: StartContainerParams) {
...
object StartContainer extends ((DockerClientContext, ContainerId, StartContainerParams) => Unit) {

  def apply(clientContext: DockerClientContext, id: ContainerId, params: StartContainerParams): Unit =
