 ...
 */
class AttachToContainer(id: ContainerId, params: AttachToContainerParams) {
...
object AttachToContainer extends ((DockerClientContext, ContainerId, AttachToContainerParams) => InputStream) {

  def apply(clientContext: DockerClientContext, id: ContainerId, params: AttachToContainerParams): InputStream =
